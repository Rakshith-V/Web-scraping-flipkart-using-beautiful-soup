...
url = "https://www.flipkart.com/search?q=microwave+oven&sid=j9e%2Cm38%2Co49&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_0_7&otracker1=AS_QueryStore_OrganicAutoSuggest_0_7&as-pos=0&as-type=RECENT&as-backfill=on&page="
...
base_url = "https://www.flipkart.com/microwave-ovens/pr?sid=j9e%2Cm38%2Co49&page="
...
while x <= 8:
    ...
    for a in links:
        ...
        query= "insert into oven1_details(urls) values('%s')"%(all_links)
        print(query)
        cur.execute(query)
        db.commit()
    x =x+1
