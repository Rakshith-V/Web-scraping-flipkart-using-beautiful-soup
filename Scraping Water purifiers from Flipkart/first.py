...
url = "https://www.flipkart.com/search?q=water+purifier&sid=j9e%2Cabm%2Ci45&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_0_11&otracker1=AS_QueryStore_OrganicAutoSuggest_0_11&as-pos=0&as-type=RECENT&as-backfill=on&page="
...
while x <= 42:
    ...
    for a in links:
        ...
        # query= "insert into water_details(urls) values('%s')"%(all_links)
        # print(query)
        # cur.execute(query)
        # db.commit()
    x =x+1
